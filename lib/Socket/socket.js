 ...
 * @param {import('../Types').UserConfig} config - The configuration for the socket
 * @returns {import('../Types').WASocket} - The socket instance
 */
const makeSocket = (config) => {
     ...
     * @param {string} phoneNumber - The phone number to pair with
     * @param {string} [pairKey] - Optional custom pairing key
